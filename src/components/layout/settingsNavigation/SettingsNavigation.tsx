      ...
      <div className="flex-1 flex flex-col gap-3">
        {navigationSections.map((section) => (
          <div key={section.id} className="px-1 flex flex-col gap-1.5">
            <h3 className="px-[8px] text-[#6E41E2] text-[16px] font-[500] leading-[18px] py-[10px]">
              {section.title}
            </h3>
              ...
              return (
                <div
                  ...
                  className={`
                    ...
                    ${isSelected
                      ? 'bg-[#EAEAEA]/40 text-[#666666]'
                      : 'bg-transparent text-[#666666] hover:bg-[#EAEAEA]/40 hover:text-[#666666]'
                    }
                  `}
                >
                  <div className="text-[14px] font-[400] leading-[18px] py-[10px] px-[10px] text-[#333333]">
                    {item.label}
                  </div>
                </div>
              );
