      ...
      <div className="bg-white border border-[#CCCCCC80] rounded-[4px] overflow-hidden">
        {moduleSections.map((section, index) => (
          <div key={section.title}>
            <div
              className={[
                "bg-[#FAFAFA] h-[40px] px-4 flex items-center text-[13px] font-[400] text-[#333333] border-[#CCCCCC80]",
                index > 0 ? "mt-6" : "",
              ].join(" ")}
            >
              {section.title}
        ...
        {settingsSections.map((section, index) => {
          ...
          return (
            <div key={section.title} className={index === 0 && moduleSections.length > 0 ? "mt-5" : ""}>
              <div className="bg-[#FAFAFA] h-[40px] px-4 flex items-center text-[13px] font-[400] text-[#333333] border-[#CCCCCC80]">
                {section.title}
              </div>
