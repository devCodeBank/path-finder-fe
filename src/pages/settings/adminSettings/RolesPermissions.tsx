  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="bg-white border border-[#CCCCCC80] rounded-[4px] overflow-hidden">
        ...
        <div className="grid h-[52px] grid-cols-[2.2fr_2.8fr_1.4fr_0.6fr_0.5fr] gap-2 px-4 text-[13px] font-[400] text-[#333333] border-b border-[#CCCCCC80] bg-[#F9FAFB] items-center">
